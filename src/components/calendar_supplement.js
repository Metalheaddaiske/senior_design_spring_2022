...
export function turnOnEventNotifications() {
...
export function onlyDotsDisplay() {
    calendarInstance.setOptions( {
        useOnlyDotEventsForMainDisplay: true
    } );
}

export function setCurrentDisplayDate() {
...
export function getCopiedEvent() {
    var today = new Date(),
